        ...
        <div id="page-content-wrapper">
            <div class="container-fluid">
                <div class="row">
                    ...
                    <%
                        User u = Models.userModel.updateUser(user);
                        u.setProfileimage(loggedIn.getProfileimage());
                        if (u != null) {
                    ...
                    <% } %>
                    <a class="btn btn-sm btn-default" href="<%= (loggedIn.getUsertype() == 1) ? "dashboard.jsp?page=users&action=edit&id= " + user.getUserid() : "/eMentor/profile.jsp" %> ">Go Back</a>
                </div>
            </div>
        </div>
    </div>
